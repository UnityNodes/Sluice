...
### Tests
103 Jest tests across the predicate engine (12 operators × edge cases, regex ReDoS guard), contract-event matching, idempotency-key uniqueness, HMAC signing/verification, webhook retry semantics, and real-event regressions.
